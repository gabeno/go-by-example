...
func main() {
	...
	// We can also visit a directory recursively, including all its sub-directories. Walk accepts
	// a callback function to handle every file or directory visited.
...
/*
   ...
   $ go run 62_directories/directories.go
