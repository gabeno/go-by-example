...
// Only exported fields will be encoded/decoded in JSON. Fields must start with capital letters
// to be exported.
...
func main() {
	...
	// JSON representation on standard out. We can also stream JSON encodings directly to
