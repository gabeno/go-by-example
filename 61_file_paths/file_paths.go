...
func main() {
	...
	// You should always use Join instead of concatenating /s (front-slashes) or \s (back-slashes)
	// manually. In addition to providing portability, Join will also normalize paths by removing
...
/*
   ...
   $ go run 61_file_paths/file_paths.go
   dir1/dir2/filename
   dir1:/filename
   dir1/filename
   Dir(p): dir1/dir2
