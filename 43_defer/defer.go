...
/*
   ...
   usually for purposes of cleanup. defer is often used where e.g. ensure and finally would be
   used in other languages.
*/

func main() {
	// Suppose we wanted to create a file, write to it, and then close when we’re done. Here’s how
	// we could do that with defer.
